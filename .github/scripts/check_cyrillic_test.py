...
class CyrillicCheckTest(unittest.TestCase):
    ...
    def test_rejects_retired_ignored_paths_setting(self):
            ...
            "ignored_paths": [
                {
                    ...
                    "reason": "Path exemptions are no longer supported.",
                }
            ],
            "allowed_lines": [],
        }
        ...
        self.assertEqual(2, result.returncode)
        self.assertIn("ignored_paths", result.stderr)
